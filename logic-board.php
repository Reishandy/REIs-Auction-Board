        ...
        if ($entry["email"] == $_SESSION["email"]) {
            ...
            <th>
                  <form method='post'>
                       ...
                       <button type='submit' class='btn btn-outline-danger' style='width: 100%'>Remove</button>
                  </form>                                         
             </th>
            ";
        } else {
            ...
            <th>
                  <form method='post' class='align-items-baseline'>
                        ...
                        <input type='number' class='form-control text-center' name='bidAmount' id='bidAmount' 
